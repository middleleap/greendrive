...
const STATS = [
  ...
  },
  {
    ...
    iconPath: 'M12 21V11m0 0l-3 3m3-3l3 3M6.4 18H5a2 2 0 01-2-2v0a2 2 0 012-2h.5A6.5 6.5 0 0112 7.5 6.5 6.5 0 0118.5 14h.5a2 2 0 012 2v0a2 2 0 01-2 2h-1.4',
  },
  {
    key: 'fuel',
  ...
  return (
    <Card>
      ...
      <div className="grid grid-cols-2 gap-3">
        {STATS.map(s => (
          <div key={s.key} className={`impact-card bg-gradient-to-br ${s.gradient} relative overflow-hidden`}>
            ...
            <div className="relative">
              <svg className="w-7 h-7 mx-auto text-white/70 mb-2" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
                <path d={s.iconPath} />
              </svg>
