...
export default function OrderSummary({
  ...
  const greenDown = purchasePrice * 0.1;
  ...
  const teslaDown = purchasePrice * 0.2;
  ...
  return (
    <div className="tc-order-summary">
      <div className="max-w-lg mx-auto">
        ...
        <button onClick={() => setShowDetails(!showDetails)} className="tc-terms-link mb-4 block">
          ...
          <div className="space-y-6">
            <div className="p-5 rounded-xl border-2 border-green-deep bg-green-pale">
              ...
              <div className="grid grid-cols-3 gap-4 text-center">
                <div>
                  <p className="text-lg font-bold text-green-deep">
                    AED {Math.round(greenEmi).toLocaleString()}
                  </p>
                  <p className="text-xs text-bank-gray-mid">Monthly EMI</p>
                </div>
                <div>
                  <p className="text-lg font-bold text-bank-gray-dark">
                    AED {Math.round(greenDown).toLocaleString()}
                  </p>
            ...
            <div className="p-4 rounded-xl bg-bank-gray-bg">
              <p className="text-xs font-semibold text-bank-gray-mid uppercase tracking-wider mb-3">
                vs Tesla Finance (0% APR)
              </p>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span className="text-bank-gray-mid">Tesla down payment (20%)</span>
                  <span className="text-bank-gray-dark">
                    AED {Math.round(teslaDown).toLocaleString()}
                  </span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between pt-2 border-t border-bank-gray-alt">
                  ...
                  <span className="text-green-deep font-bold">
                    AED {Math.round(teslaDown - greenDown).toLocaleString()}
                  </span>
                </div>
              </div>
            </div>
            ...
            <p className="text-xs text-bank-gray text-center">
              Indicative figures only. Subject to credit approval.
            </p>
          </div>
        ) : (
