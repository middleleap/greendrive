...
export default function FleetScreen({ fleet, onSelectVehicle }) {
  return (
    <div className="space-y-4 pb-6">
      ...
      {/* Alert Badges */}
      <AlertBadges fleet={fleet} onAlertClick={(alert) => {
      ...
      <button className="mv-add-vehicle-card w-full">
        <svg className="w-6 h-6 text-bank-gray-mid mb-1" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
