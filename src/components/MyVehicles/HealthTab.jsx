  ...
  if (!vehicle.connected || !score) {
    return (
      <div className="mv-section-card text-center py-8">
        <svg className="w-8 h-8 text-bank-gray-mid mx-auto mb-2" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
