      ...
      {loan.newRate && (
        <div className="mv-refinance-callout">
          <div className="flex items-center gap-2 mb-2">
            <svg className="w-4 h-4 text-green-deep" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="flex items-center gap-3 mb-3">
            ...
            <svg className="w-4 h-4 text-green-main" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>
          ...
          <div className="grid grid-cols-2 gap-2 mb-3">
            <div className="text-center p-2 rounded-lg bg-white/60">
              ...
              <p className="text-[8px] text-bank-gray-mid uppercase tracking-wider">Monthly Saving</p>
            </div>
            <div className="text-center p-2 rounded-lg bg-white/60">
              <p className="text-sm font-semibold text-green-deep">
                AED {loan.annualSaving.toLocaleString()}
              </p>
              <p className="text-[8px] text-bank-gray-mid uppercase tracking-wider">Annual Saving</p>
            </div>
          </div>
