  ...
  return (
    <div className="space-y-4">
      ...
      <div className="mv-section-card">
        <h4 className="text-[10px] uppercase tracking-widest text-bank-gray-mid mb-3">Vehicle Identity</h4>
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        <div className="mv-summary-card">
          <p className="text-[9px] uppercase tracking-wider text-bank-gray-mid mb-1">Loan Balance</p>
        ...
        {oem && (
          <div className="mv-summary-card">
            <p className="text-[9px] uppercase tracking-wider text-bank-gray-mid mb-1">Efficiency</p>
            <p className="text-base font-semibold text-bank-gray-dark">{oem.efficiencyWhKm} Wh/km</p>
